...
locus_plots <- cad_locus_top5 %>%
  ...
  mutate(locus_plot = map(data, ~locusplotr::gg_locusplot(df = .x, rsid = marker_id, chrom = chromosome, pos = position, p_value = p_value, ref = allele1, alt = allele2, plot_genes = TRUE, plot_recombination = TRUE, genome_build = "GRCh38")))
