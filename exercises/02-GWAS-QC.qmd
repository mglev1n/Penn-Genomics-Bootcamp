...
Here are some of the key steps of GWAS meta-analysis:
<https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4083217/>

1. Setting up logistics of Meta-analysis
1. Collecting aggregated statistics per study
1. File-Level QC
1. Identification of analytical issues by the SE-N plot
1. Identification of analytical issues by the P-Z plot
1. Identification of problems with allele- frequencies or strand
1. Identification of population stratification
1. Meta-Analysis
1. Meta-analysis QC – Compare results from two analysts
1. Meta-analysis QC – Identify analytical issues by calculating the study-level λGC
1. Finalizing meta-Analysis
...
$$Z=\frac{\beta}{SE}$$
$$SE = abs(\frac{\beta}{qnorm(p_{value}/2)})$$
...
`GWASinspector` is an R package that can help you identify issues with your summary statistics. It can be used to generate a variety of plots that can help you identify issues with your data. You can install `GWASinspector` from CRAN:
